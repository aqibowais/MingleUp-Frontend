...
const SettingsPage = () => {
  ...
  return (
    <div className="min-h-screen container mx-auto p-5 max-w-6xl">
      <div className="space-y-2">
          ...
          {THEMES.map((t) => (
            ...
            >
              ...
              <span className={`text-[13px] font-medium truncate w-full text-center ${
                theme === t ? "text-primary font-semibold" : ""
              }`}>
        ...
        <div className="mb-10 rounded-xl border border-base-300 overflow-hidden bg-base-100 ">
